            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>MgtStrat Webinars Record</h3>
                    ...
                    <div class="col-12 col-md-6 order-md-2 order-first">
                        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">MgtStrat Webinars</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <section class="section">
                <div class="card mb-5 mt-5">
                    <div class="card-header col-12 d-flex justify-content-left mt-3 mb-3 mx-3">
                        <a class="btn btn-primary mt-2 mb-2" href="{{ URL::to('form/webinars/new') }}">
                            ...
                            <tbody>
                                @foreach ($data as $key => $item)
                                    <tr>
                                        ...
                                        <td class="id text-center text-uppercase fw-bold">{{ $item->webinar_id }}</td>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h3 class="mb-2 text-center">Delete Webinar Record</h3>
                                                        </div>
                                                        <div class="modal-body">
                                                            ...
                                                            <form action="{{ route('deleteRecord') }}" method="POST">
                                                                ...
                                                                <input type="hidden" name="webinar_id" class="budget_number" value="{{ $item->webinar_id }}" readonly>
