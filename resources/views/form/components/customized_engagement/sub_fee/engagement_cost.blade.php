                    ...
                    @foreach ($data3 as $key=>$cost_types )
                        ...
                        <tr class="table-warning" id="salesRow">
                            <td class="title table-light">
                                <input type="hidden" value="Sales" name="cost_type[]" readonly>
                ...
                <tbody id="tableReferral">
                    @foreach ($data3 as $key=>$cost_types )
                        ...
                        <tr class="table-warning" id="referralRow">
                            <td class="title table-light">
                                Referral (2% / 3%)
                                <input type="hidden" value="Referral" name="cost_type[]" readonly>
                                <input type="hidden" name="cost_id[]" value="{{$cost_types->id }}">
                            </td>
                            <td>
                    ...
                    @foreach ($data3 as $key=>$cost_types )
                        ...
                        <tr class="table-warning" id="engagementmanagerRow">
                            <td class="title fw-bold text-dark table-light">
                                ENGAGEMENT MANAGER
                                <input type="hidden" class="d-none" value="Engagement Manager" name="cost_type[]" readonly>
                                <input type="hidden" name="cost_id[]" value="{{$cost_types->id }}">
                            </td>
                            <td><input type="text" class="d-none" value="" name="cost_consultant_num[]" readonly></td>
                            <td>
                        ...
                        <tr class="table-warning" id="ec_LeadConsultant">
                            ...
                            <td class="">
                                <input type="text"
                                    ...
                                    value="{{ $cost_types->consultant_num }}" name="cost_consultant_num[]" id="ec_LeadconsultantNoc1" data-type="currency">
                            </td>
                            <td class="">
                                <input type="text"
                                    class="text-center fw-bold text-dark form-control input-table commanumber val @error('') is-invalid @enderror"
                                    value="{{ $cost_types->hour_fee }}" name="cost_hour_fee[]" id="ec_LeadconsultantHf1" data-type="currency">
                            </td>
                            <td class="">
                                <input type="text"
                                    class="text-center form-control input-table commanumber @error('') is-invalid @enderror"
                                    value="{{ $cost_types->hour_num }}" name="cost_hour_num[]" id="ec_LeadconsultantNoh1" data-type="currency" >
                            </td>
                            <td class="">
                                <input type="text"
                                    class="text-center form-control input-table commanumber @error('') is-invalid @enderror"
                                    value="{{ $cost_types->nswh }}" name="cost_nswh[]" id="ec_LeadconsultantNwh1" data-type="currency" >
                            </td>
                            <td class="total-td table-light">
                            ...
                            <td class="total-td table-light">
                                <input class="text-uppercase form-control input-table @error('') is-invalid @enderror"
                                    value="{{ $cost_types->rooster }}" name="cost_rooster[]" id="roster1">
                            </td>
                            <td class="total-td table-light">
                                <textarea class="form-control input-table @error('') is-invalid @enderror"
                ...
                <tbody id="ec_tableAnalyst">
                    @foreach ($data3 as $key=>$cost_types )
                        ...
                        <tr class="table-warning" id="ec_Analyst1">
                            <td class="title table-light">
                                <input type="hidden" name="cost_id[]" value="{{$cost_types->id }}">
                                <input type="hidden" value="Analyst" name="cost_type[]" readonly>
                                Analyst
                            </td>
                            <td>
                                <input type="text"
                    ...
                    @foreach ($data3 as $key=>$cost_types )
                        ...
                        <tr class="table-warning" id=ec_DesignerRow1>
                            <td class="title table-light">Designer
                                <input type="hidden" name="cost_id[]" value="{{$cost_types->id }}">
                                <input type="hidden" class="d-none" value="Designer" name="cost_type[]" readonly>
                            </td>
                            <td class="">
                                <input type="text"
                                    class="text-center form-control input-table commanumber @error('') is-invalid @enderror"
                    ...
                    @foreach ($data3 as $key=>$cost_types )
                        ...
                        <tr class="table-warning" id="ec_CreatorsRow1">
                            <td class="title table-light">
                                Creators Fees
                                <input type="hidden" name="cost_id[]" value="{{$cost_types->id }}">
                                <input type="hidden" class="d-none" value="Creators Fees" name="cost_type[]" readonly>
                            </td>
                            <td>
                                <input type="text"
                                    class="text-center form-control input-table commanumber @error('') is-invalid @enderror"
                    ...
                    @foreach ($data3 as $key=>$cost_types )
                        ...
                        <tr class="table-warning">
                            <td class="title table-light">
                                Lead Facilitator
                                <input type="hidden" name="cost_id[]" value="{{$cost_types->id }}">
                                <input type="hidden" class="d-none" value="Lead Facilitator" name="cost_type[]" readonly>
                            </td>
                            <td>
                                <input type="text"
                                    class="text-center form-control input-table commanumber @error('') is-invalid @enderror"
                    ...
                    @foreach ($data3 as $key=>$cost_types )
                        ...
                        <tr class="table-warning">
                            <td class="title table-light">
                                Co-Lead
                                <input type="hidden" name="cost_id[]" value="{{$cost_types->id }}">
                                <input type="hidden" class="d-none" value="Co-Lead" name="cost_type[]" readonly>
                            </td>
                            <td>
                                <input type="text"
                                    class="text-center form-control input-table commanumber @error('') is-invalid @enderror"
                    ...
                    @foreach ($data3 as $key=>$cost_types )
                        ...
                        <tr class="table-warning">
                            <td class="title table-light">
                                AL Coach
                                <input type="hidden" name="cost_id[]" value="{{$cost_types->id }}">
                                <input type="hidden" class="d-none" value="AL Coach" name="cost_type[]" readonly>
                            </td>
                            <td>
                                <input type="text"
                                    class="text-center form-control input-table commanumber @error('') is-invalid @enderror"
                    ...
                    @foreach ($data3 as $key=>$cost_types )
                        ...
                        <tr class="table-warning">
                            <td class="title table-light">
                                ...
                                <input type="hidden" name="cost_id[]" value="{{$cost_types->id }}">
                                <input type="hidden" class="d-none" value="Co-Facilitator / Resource Speaker" name="cost_type[]" readonly>
                            </td>
                            <td>
                                <input type="text"
                    ...
                    @foreach ($data3 as $key=>$cost_types )
                        ...
                        <tr class="table-warning">
                            <td class="title table-light">
                                Moderator
                                <input type="hidden" name="cost_id[]" value="{{$cost_types->id }}">
                                <input type="hidden" class="d-none" value="Moderator" name="cost_type[]" readonly>
                            </td>
                            <td>
                                <input type="text"
                    ...
                    @foreach ($data3 as $key=>$cost_types )
                        ...
                        <tr class="table-warning">
                            <td class="title table-light">
                                Producer
                                <input type="hidden" name="cost_id[]" value="{{$cost_types->id }}">
                                <input type="hidden" class="d-none" value="Producer" name="cost_type[]" readonly>
                            </td>
                            <td>
                                <input type="text"
                    ...
                    @foreach ($data3 as $key=>$cost_types )
                        ...
                        <tr class="table-warning">
                            <td class="title table-light">
                                Documentor
                                <input type="hidden" name="cost_id[]" value="{{$cost_types->id }}">
                                <input type="hidden" class="d-none" value="Documentor" name="cost_type[]" readonly>
                            </td>
                            <td>
                                <input type="text"
                                    class="text-center text-dark fw-bold form-control input-table commanumber @error('') is-invalid @enderror"
                ...
                @foreach ($data3 as $key=>$cost_types )
                    ...
                    <tr class="table-warning">
                        <td class="title table-light">
                            Off-Program fee
                            <input type="hidden" name="cost_id[]" value="{{$cost_types->id }}">
                            <input type="hidden" class="d-none" value="Off-Program fee" name="cost_type[]" readonly>
                        </td>
                        <td>
                            <input type="text"
                ...
                @foreach ($data3 as $key=>$cost_types )
                    ...
                    <tr class="table-warning">
                        <td class="title table-light">
                            Program Expenses
                            <input type="hidden" name="cost_id[]" value="{{$cost_types->id }}">
                            <input type="hidden" class="d-none" value="Program Expenses" name="cost_type[]" readonly>
                        </td>
