    ...
    <script>
        @foreach($subFeeList as $fee)
            ...
            @if($fee->type == 'Lead Consultant')
                ...
                document.getElementById('ef_LeadconsultantHf1').value = '{{ ($fee->day_fee) ? $fee->day_fee : 56000 }}';
            ...
            @if($fee->type == 'Analyst')
                ...
                document.getElementById('ef_AnalystPdf').value = '{{ ($fee->day_fee) ? $fee->day_fee : 0}}';
            ...
            @if($fee->type == 'Designer')
                ...
                document.getElementById('ef_DesignerPdf').value = '{{ ($fee->day_fee) ? $fee->day_fee : 48000 }}';
