            ...
            <table class="table table-bordered" id="f2f-ef-table">
                    ...
                    <tr class="th-blue-grey-lighten-2" id="leadConsultant1">
                        ...
                        <td data-title="# OF CONSULTANTS">
                            <input type="number"
                                ...
                                value="{{ old('') }}" name="fee_noc[]" id="ef_LeadconsultantNoc1" min="0"
                                max="100"
                        ...
                        <td>
                            <fieldset>
                                <select class="form-select hf-c13 input js-mytooltip @error('') is-invalid @enderror"
                                    name="fee_pd[]" id="ef_LeadconsultantHf"
                                    ...
                                    <option value="56000" {{ old('') == '56000' ? 'selected="selected"' : '' }}
                                        selected>
                                        &#8369;56,000
                                    </option>
                        ...
                        <td>
                            <input type="number"
                                ...
                                value="{{ old('') }}" name="fee_nod[]" id="ef_LeadconsultantNoh1"
                    ...
                    <tr class="th-blue-grey-lighten-2" id="ef_RowAnalyst">
                        ...
                        <td>
                            <input type="number"
                                ...
                                value="{{ old('') }}" name="fee_noc[]" id="ef_AnalystNoc1" max="100"
                                data-mytooltip-content="<i>Includes in depth needs analysis (i.e. surveys, interviews, FGDs),
                                special research (i.e. to study client materials or client -required materials, industry
                                or function specific content), creation of client-specific learning aids/tools
                                (i.e. assessments, c</i>"
                        ...
                        <td>
                            <input type="text" class="form-control input-table @error('') is-invalid @enderror"
                                value="{{ old('') }}" name="fee_pd[]" id="ef_AnalystPdf"
                                data-type="currency">
                        </td>
                        <td>
                            <input type="number"
                                class=" input js-mytooltip form-control input-table @error('') is-invalid @enderror"
                                value="{{ old('') }}" name="fee_nod[]" id="ef_AnalystNod1"
                                data-mytooltip-content="<i>½ Day = 0.50<br>
                        ...
                        <td class="total-td">
                            <input type="text" class="form-control input-table @error('') is-invalid @enderror"
                                value="{{ old('') }}" name="fee_notes[]" id="ef_AnalystNotes">
                        </td>
                    </tr>
                </tbody>
                    ...
                    <tr class="th-blue-grey-lighten-2" id="ef_RowDesigner">
                        ...
                        <td>
                            <input type="number"
                                ...
                                value="{{ old('') }}" name="fee_noc[]" id="ef_DesignerNoc1" max="100"
                                data-mytooltip-content="<i>Includes in depth needs analysis (i.e. surveys, interviews, FGDs),
                                special research (i.e. to study client materials or client -required materials, industry
                                or function specific content), creation of client-specific learning aids/tools
                                (i.e. assessments, c</i>"
                        ...
                        <td>
                            <input type="number"
                                ...
                                value="{{ old('') }}" name="fee_nod[]" id="ef_DesignerNod1"
                                data-mytooltip-content="<i>½ Day = 0.50<br>
                    ...
                    <tr class="th-blue-grey-lighten-2" id="ef_RowLeadFaci">
                        ...
                        <td>
                            <input type="number"
                                ...
                                value="{{ old('') }}" name="fee_noc[]" id="ef_LeadFaciNoc1" max="100">
                        </td>
                        <td>
                            <input type="text"
                                class="form-control js-mytooltip input-table @error('') is-invalid @enderror"
                                value="{{ old('') }}" name="fee_pd[]" id="ef_LeadFaciPdf"
                        ...
                        <td>
                            <input type="number"
                                ...
                                value="{{ old('') }}" name="fee_nod[]" id="ef_LeadFaciNod1"
                    ...
                    <tr class="th-blue-grey-lighten-2" id="ef_RowCoFaci">
                        ...
                        <td>
                            <input type="number"
                                ...
                                value="{{ old('') }}" name="fee_noc[]" id="ef_CoFaciNoc1" max="100">
                        </td>
                        <td>
                            <input type="text"
                                class="hf-c22 form-control input-table @error('') is-invalid @enderror"
                                value="{{ old('') }}" name="fee_pd[]" id="ef_CoFaciPdf";
                                data-mytooltip-content="<i>½ Day = 0.70</i>" data-mytooltip-theme="dark"
                        ...
                        <td>
                            <input type="number"
                                ...
                                value="{{ old('') }}" name="fee_nod[]" id="ef_CoFaciNod1"
                                data-mytooltip-content="<i>½ Day = 0.70</i>" data-mytooltip-theme="dark"
                                data-mytooltip-action="focus" data-mytooltip-direction="bottom">
                        </td>
                        <td>
                ...
                <tbody id="ef_TableActionLearn">
                    <tr class="th-blue-grey-lighten-2" id="ef_RowActionLearn">
                        <td class="title">
                            <input type="text" class="d-none" value="Action Learning Coach" name="fee_type[]" readonly>
                            Action Learning Coach
                        </td>
                        <td>
                            <input type="number"
                ...
                <tbody id="ef_TableMarshal">
                    <tr class="th-blue-grey-lighten-2" id="ef_RowMarshal">
                        ...
                        <td>
                            <input type="number"
                                class="noc-b23 form-control input-table @error('') is-invalid @enderror"
                                value="{{ old('') }}" name="fee_noc[]" id="ef_MarshalNoc1" max="100">
                        </td>
                        <td>
                            <input type="text"
                                class="hf-c22 form-control input-table @error('') is-invalid @enderror"
                                value="{{ old('') }}" name="fee_pd[]" id="ef_MarshalPdf"
                                data-type="currency";>
                        </td>
                        <td>
                            <input type="number"
                                class="noh-d23 input js-mytooltip form-control input-table @error('') is-invalid @enderror"
                                value="{{ old('') }}" name="fee_nod[]" id="ef_MarshalNod1"
                                data-mytooltip-content="<i>½ Day = 0.70</i>" data-mytooltip-theme="dark"
                                data-mytooltip-action="focus" data-mytooltip-direction="bottom">
                        </td>
                        <td>
                ...
                <tbody id="ef_TableOnsite">
                    <tr class="th-blue-grey-lighten-2" id="ef_RowOnsite">
                        <td class="title">
                            <input type="text" class="d-none" value="On-site PC (P20K / P25K / P30K)" name="fee_type[]" readonly>
                            On-site PC (P20K / P25K / P30K)
                        </td>
                        <td>
                            <input type="number"
                                class="noc-b23 form-control input-table @error('') is-invalid @enderror"
                                value="{{ old('') }}" name="fee_noc[]" id="ef_OnsiteNoc1" max="100">
                        </td>
                        <td>
                            <fieldset>
                                <select class="form-select hf-c13 input js-mytooltip @error('') is-invalid @enderror"
                                    name="fee_pd[]" id="ef_OnsitePdf"
                    ...
                    <tr class="th-blue-grey-lighten-2" id="ef_RowDocumentor">
                        ...
                        <td>
                            <input type="number"
                                ...
                                value="{{ old('') }}" name="fee_noc[]" id="ef_DocumentorNoc1" max="100">
                        </td>
                        <td>
                            <input type="text"
                                class="hf-c22 form-control input-table @error('') is-invalid @enderror"
                                value="{{ old('') }}" name="fee_pd[]" id="ef_DocumentorPdf"
                                data-type="currency";>
                        </td>
                        <td>
                            <input type="number"
                                class="noh-d28 input js-mytooltip form-control input-table @error('') is-invalid @enderror"
                                value="{{ old('') }}" name="fee_nod[]" id="ef_DocumentorNod1"
                                data-mytooltip-content="<i>½ Day = 0.70</i>" data-mytooltip-theme="dark"
                                data-mytooltip-action="focus" data-mytooltip-direction="bottom">
                        </td>
                        <td>
                ...
                <tr class="th-blue-grey-lighten">
                    <th class="title px-4 text-dark">
                        <input type="text" class="d-none" value="Per Diem" name="fee_type[]" readonly>
                        5. PER DIEM
                    </th>
                    <td>
                    ...
                    <td>
                        <input type="text" class="hf-c22 form-control input-table @error('') is-invalid @enderror"
                            value="{{ old('') }}" name="fee_pd[]" id="ef_PDPdf";>
                    </td>
                    <td>
                        <input type="number"
                ...
                <tr class="table-active">
                    ...
                    <td class="overall-total-end table-warning">
                        <input type="text"
                            ...
                            value="{{ old('') }}" name="fee_total" id="input_totalPackages"
