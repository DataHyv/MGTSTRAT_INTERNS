        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>MGTSTRAT-U Webinar Sub Fee</h3>
                </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">                                                           
                        <a href="{{ url('form/webinarEngagement/sub-form/modify-sessions/' . $parentData[0]->id) }}" class="btn btn-success active" role="button">
            ...
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <div class="card-body">
                        ...
                        <!------------ BUDGET FORM ------------>
                            <form class="form form-horizontal multisteps-form__form" action="{{ route('form/webinarEngagement/sub-form/save_editSubForm') }}"
                                method="POST" autocomplete="off" onsubmit="submitForm(event)" name="sub_webinar_engagement_form">
                                @csrf
                                @method('PUT')       
                                ...
                                <div class="multisteps-form__panel js-active" data-animation="slideHorz">
                                    @include('form.components.mgtstrat_u_webinar.sub_form.engagement_fees')
                                ...
                                <div class="multisteps-form__panel" data-animation="slideHorz">
                                    @include('form.components.mgtstrat_u_webinar.sub_form.engagement_cost')
