...
@section('content')
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>MGTSTRAT-U Webinar</h3>
                </div>
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
                            <li class="breadcrumb-item active" aria-current="page">MGTSTRAT-U Webinar</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="col-12 col-lg-8 ml-auto mr-auto mb-4">
                    <div class="multisteps-form__progress">
                        <button class="multisteps-form__progress-btn js-active" type="button"
                            title="User Info" id="webinar_engagement_info">Information</button>
            ...
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <div class="card-body">
                        ...
                        {{-- Budget form --}}
                        @if($parentInfoList)             
                            <form class="form form-horizontal multisteps-form__form" action="{{ route('save_update_webinar_record') }}"
                            method="POST" autocomplete="off" onsubmit="submitForm(event)" name="webinar_engagement_form" id="webinar_engagement_form">  
                                @csrf 
                                @method('PUT')
                                <input class="form-control" type="hidden" id="engagement_form_id" name="engagement_form_id" value="{{$parentInfoList->id}}">   
                        @else
                            <form class="form form-horizontal multisteps-form__form" action="{{ route('webinar_record_save') }}" method="POST" autocomplete="off" name="webinar_engagement_form" id="webinar_engagement_form">
                            @csrf
                        @endif    

                            {{-- INFORMATION --}}
                            <div class="multisteps-form__panel js-active" data-animation="slideHorz">
                                @include('form.components.mgtstrat_u_webinar.webinar_information')
                                {{-- next button --}}
                            ...
                            <div class="multisteps-form__panel" data-animation="slideHorz">
                                @include('form.components.mgtstrat_u_webinar.webinar_engagementFees')
                            ...
                            {{-- ENGAGEMENT COST --}}
                            <div class="multisteps-form__panel" data-animation="slideHorz">
                                @include('form.components.mgtstrat_u_webinar.webinar_engagementCost')
                                {{-- next and prev button --}}
                                <div class="col-12 d-flex justify-content-center mt-3">
                                    <button class="btn btn-secondary mx-2 js-btn-prev" type="button"
                                        title="Prev">Prev</button>
                            ...
                            {{-- PROFIT FORECAST --}}
                            <div class="multisteps-form__panel" data-animation="slideHorz">
                                @include('form.components.mgtstrat_u_webinar.webinar_profit_forecast')
    ...
    <script type="text/javascript" src="/js/webinarform.js"></script>
    ...
    <script>
        function validate_required_field() {
            ...
            var forms = document.getElementById('webinar_engagement_form');
            if (forms.checkValidity() === false) {
                forms.classList.add('was-validated');
                document.getElementById('webinar_engagement_info').click();
