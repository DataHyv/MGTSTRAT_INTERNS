            ...
            <!-------------------- CONSULTING/DESIGN ----------------------->
                ...
                <tbody class="sum" id="">
                    <tr class="table-warning">
                        ...
                        <td>
                            <fieldset>
                                <select class="daily-fees text-center form-select input js-mytooltip @error('') is-invalid @enderror" name="[]" id="" data-mytooltip-content="<i> Consulting - &#8369;5,000 - Consultants <br> &#8369;6,250 - Senior Consultants</i>" data-mytooltip-theme="dark" data-mytooltip-action="focus" data-mytooltip-direction="right" style="background-color:#ffcccc; color:red;">
                        ...
                        <td>
                            <input type="text" class="number-session form-control input-table input js-mytooltip commanumber @error('') is-invalid @enderror" value="{{ old('') }}" name="" id="" data-type="currency">
                        </td>

                        <td>
                            <input type="text" class="nswh form-control input-table commanumber @error('') is-invalid @enderror" value="{{ old('') }}" name="" id="" data-type="currency">
                        </td>
            ...
            <!-------------------- CONSULTING/DESIGN ----------------------->
                ...
                <tbody class="sum" id="">
                    <tr class="table-warning">
                        ...
                        <td>
                            <input type="text" class="daily-fees form-control input-table input js-mytooltip commanumber @error('') is-invalid @enderror" value="{{ old('') }}" name="" id="" data-type="currency">
                        </td>
