...
<div class="form-body">
    <section>
        ...
        <table class="table table-bordered" id="workshop-table">
            <thead class="table">
            ...
            <tr class="th-blue-grey-lighten">
                ...
                <td style="background-color: #FFFFFF; border-top: 2px solid white" class="add-row bg-white" scope="col"></td>
            </tr>
            <!---------------SALE-------------------------->
            <tbody id="tableofSale">
                <tr class="th-blue-grey-lighten-2" id="rowofSale">
                    ...
                    <td class="total-td tbl-engmt-cost" style="border-left:3px solid black">
                        <h4 class="text-center text-danger " id="workshop_saleTotal1">-</h4>
                    </td>
                    <td class="total-td">                        
                    ...
                    <td class="total-td">
                        <textarea type="text" class="form-control input-table @error('') is-invalid @enderror"
                            value="{{ old('') }}"name="cost_notes[]" id="ec_workshop_saleNotes1"></textarea>
                    </td>
            ...
            <tbody id="tableofReferrals">
                <tr class="th-blue-grey-lighten-2" id="rowofReferrals">
                    ...
                    <td><input type="hidden" class="d-none" name="cost_nswh[]" readonly></td>
                    <td class="total-td tbl-engmt-cost" style="border-left:3px solid black">
                        <h4 class="text-center text-danger " id="workshop_referralsTotal1">-</h4>
                    </td>
                    <td class="total-td">
                    ...
                    <td class="total-td">
                        <textarea type="text" class="form-control input-table @error('') is-invalid @enderror"
                            value="{{ old('') }}"name="cost_notes[]" id="ec_workshop_referralsNotes1"></textarea>
                    </td>
                    <td style="background-color: #FFFFFF;" class="border border-white">
            ...
            <tbody id="tableofEngagementManager">
                <tr class="th-blue-grey-lighten" id="rowofEngagementManager">
                    ...
                    <td class="total-td tbl-engmt-cost" style="border-left:3px solid black">
                        <h4 class="text-center text-danger " id="workshop_engagementManagerTotal1">-</h4>
                    </td>
                    <td class="total-td">
                    ...
                    <td class="total-td">
                        <textarea type="text" class="form-control input-table @error('') is-invalid @enderror"
                            value="{{ old('') }}"name="cost_notes[]" id="ec_workshop_engagementManagerNotes1"></textarea>
                    </td>
                    <td style="background-color: #FFFFFF;" class="border border-white">
                ...
                <tr class="th-blue-grey-lighten-2" id="rowofCustomization">
                    ...
                    <td class="mgt-td-dark-bg">
                        <input type="text"
                            ...
                            value="{{ old('') }}" name="cost_hour_fee[]" id="workshop_CustomizationHf1"> 
                    </td>
                    <td class="table-danger">
                        <fieldset>
                            <select class="input js-mytooltip  text-center form-select @error('') is-invalid @enderror" 
                                name="cost_hour_num[]" id="workshop_CustomizationNoh1"
                                data-mytooltip-content="<i>
                                    # of Hours<br>
                    ...
                    <td class="total-td" style="border-left:3px solid black">
                        <h4 class="text-center text-danger  lead" id="workshop_CustomizationsTotal1">-</h4>
                    </td> 
                    <td class="total-td table-warning">
                        <input  type="text" class="form-control input-table" name="cost_roster[]" id="customizations_roster1"
                                value="{{ old('') }}"                                     
                                oninput="filterConsultant('customizations_roster1','workshop_CustomizationHf1','customizationFee');"
                    ...
                    <td class="total-td">
                        <textarea type="text" class="form-control input-table @error('') is-invalid @enderror"
                            value="{{ old('') }}"name="cost_notes[]" id="ec_workshop_CustomizationsNotes1"></textarea>
                    </td>
                    <td style="background-color: #FFFFFF;" class="border border-white">
            ...
            <tbody id="tableofCreator">
                <tr class="th-blue-grey-lighten-2" id="rowofCreator">
                    ...
                    <td class="table-danger">
                        <fieldset>
                            <select class="input js-mytooltip  text-center form-select @error('') is-invalid @enderror" name="cost_hour_fee[]" id="workshop_CreatorHf1"
                                data-mytooltip-content="<i>
                    ...
                    <td class="mgt-td-dark-bg">
                        <input type="text"
                            ...
                            value="{{ old('') }}" name="cost_hour_num[]" id="workshop_CreatorNoh1" max="100">
                    </td>
                    <td><input type="hidden" class="d-none" name="cost_nswh[]" readonly></td>

                    <td class="total-td" style="border-left:3px solid black">
                        <h4 class="text-center text-danger  lead" id="workshop_CreatorTotal1">-</h4>
                    </td>
                    <td class="total-td">
                    ...
                    <td class="total-td">
                        <textarea type="text" class="form-control input-table @error('') is-invalid @enderror"
                            value="{{ old('') }}"name="cost_notes[]" id="ec_workshop_CreatorNotes1"></textarea>
                    </td>
                    <td style="background-color: #FFFFFF;" class="border border-white">
            ...
            <tr class="table-secondary">
                ...
                <td class="total-td" style="background-color: rgba(146, 146, 146, 0.727">
                    <h4 class="text-center text-danger " id="workshop_DesignsSubtotal">-</h4>
                </td>
                <td class="total-td">
                </td>
                <td class="total-td">
                ...
                <tr class="th-blue-grey-lighten-2" id="rowofLeadFacilitator">
                    ...
                    <td class="mgt-td-dark-bg">
                        <input type="text"
                            ...
                            value="{{ old('') }}" name="cost_hour_fee[]" id="workshop_LeadfacilitatorsHf1">
                    </td>
                    <td class="table-warning">
                        <input type="text"
                            class="number_input text-center form-control input-table @error('') is-invalid @enderror"
                            value="{{ old('') }}" name="cost_hour_num[]" id="workshop_LeadfacilitatorsNoh1">
                    </td>
                    <td class="table-warning">
                        <input type="text"
                            class="number_input text-center form-control input-table @error('') is-invalid @enderror"
                            value="{{ old('') }}" name="cost_nswh[]" id="workshop_LeadfacilitatorsNwh1">
                    </td>
                    <td class="total-td" style="border-left:3px solid black">
                        <h4 class="text-center text-danger  lead" id="workshop_LeadfacilitatorsTotal1">-</h4>
                    </td>
                    <td class="total-td table-warning">
                        <input  type="text" class="form-control input-table" name="cost_roster[]" id="leadfacilitator_roster1"
                                value="{{ old('') }}"                                     
                                oninput="filterConsultant('leadfacilitator_roster1','workshop_LeadfacilitatorsHf1','leadFacilitator');"
                    ...
                    <td class="total-td">
                        <textarea type="text" class="form-control input-table @error('') is-invalid @enderror"
                            value="{{ old('') }}"name="cost_notes[]" id="ec_workshop_leadfacilitatorNotes1"></textarea>
                    </td>
                    <td style="background-color: #FFFFFF;" class="border border-white">
            ...
            <tbody id="tableofModerator">
                <tr class="th-blue-grey-lighten-2" id="rowofModerator">
                    ...
                    <td class="mgt-td-dark-bg">                                    
                        <input type="text"
                            class="currency_input text-center fw-bold text-center text-dark form-control input-table @error('') is-invalid @enderror"
                            value="{{ old('') }}" name="cost_hour_fee[]" id="workshop_ModeratorHf1">
                        </fieldset>
                    </td>
                    <td class="table-warning">
                        <input type="text"
                            class="text-center number_input form-control input-table @error('') is-invalid @enderror"
                    ...
                    <td class="total-td" style="border-left:3px solid black">
                        <h4 class="text-center text-danger  lead" id="workshop_ModeratorTotal1">-</h4>
                    </td>
                    <td class="total-td table-warning">
                        <input  type="text" class="form-control input-table" name="cost_roster[]" id="moderator_roster1"
                                value="{{ old('') }}"                                     
                                oninput="filterConsultant('moderator_roster1','workshop_ModeratorHf1','moderator');"
                    ...
                    <td class="total-td">
                        <textarea type="text" class="form-control input-table @error('') is-invalid @enderror"
                            value="{{ old('') }}"name="cost_notes[]" id="ec_workshop_ModeratorNotes1"></textarea>
                    </td>
                    <td style="background-color: #FFFFFF;" class="border border-white">
                ...
                <tr class="th-blue-grey-lighten-2" id="rowofProducer">
                    ...
                    <td class="mgt-td-dark-bg">
                        <input type="text"
                            ...
                            value="{{ old('') }}" name="cost_hour_fee[]" id="workshop_ProducerHf1">
                    </td>
                    <td class="table-warning">
                        <input type="text"
                            class="number_input text-center form-control input-table @error('') is-invalid @enderror"
                            value="{{ old('') }}" name="cost_hour_num[]" id="workshop_ProducerNoh1">
                    </td>
                    <td class="table-warning">
                        <input type="text"
                            class="number_input text-center form-control input-table @error('') is-invalid @enderror"
                            value="{{ old('') }}" name="cost_nswh[]" id="workshop_ProducerNwh1">
                    </td>
                    <td class="total-td" style="border-left:3px solid black">
                        <h4 class="text-center text-danger  lead" id="workshop_ProducersTotal1">-</h4>
                    </td>
                    <td class="total-td table-warning">
                    <input  type="text" class="form-control input-table" name="cost_roster[]" id="producer_roster1"
                            value="{{ old('') }}"                                     
                            oninput="filterConsultant('producer_roster1','workshop_ProducerHf1','producer');"
                    ...
                    <td class="total-td">
                        <textarea type="text" class="form-control input-table @error('') is-invalid @enderror"
                            value="{{ old('') }}"name="cost_notes[]" id="ec_workshop_ProducersNotes1"></textarea>
                    </td>
                    <td style="background-color: #FFFFFF;" class="border border-white">
            ...
            <tr class="table-secondary" id="tableofProgramSubtotal">
                ...
                <td></td>
                <td class="total-td" style="background-color: rgba(146, 146, 146, 0.727)">
                    <h4 class="text-center text-danger " id="workshop_ProgramsSubtotal">-</h4>
                </td>
                <td class="total-td"></td>
                <td class="total-td"></td>
                <td style="background-color: #FFFFFF;" class="border border-white"></td>
            ...
            <tbody id="tableofOffProgram">
                <tr class="th-blue-grey-lighten-2" id="rowofOffProgram">
                    ...
                    <td class="table-warning">
                        <input type="text"
                            class="currency_input text-center text-dark fw-bold form-control input-table @error('') is-invalid @enderror"
                            value="{{ old('') }}" name="cost_hour_fee[]" id="workshop_OffprogramsHf1">
                    </td>
                    <td class="bg-white">
                        <input type="text"
                            class="text-center  form-control input-table @error('') is-invalid @enderror currency_input"
                            value="{{ old('') }}" name="cost_hour_num[]" id="workshop_OffprogramsNoh1">
                    </td>
                    <td><input type="hidden" class="d-none" name="cost_nswh[]" readonly></td>
                    <td class="total-td" style="background-color: rgba(146, 146, 146, 0.727">
                        <h4 class="text-center text-danger " id="workshop_OffprogramsTotal1">-</h4>
                    </td>                    
                    <td class="total-td">
                    ...
                    <td class="total-td">
                        <textarea type="text" class="form-control input-table @error('') is-invalid @enderror"
                            value="{{ old('') }}"name="cost_notes[]" id="ec_workshop_OffprogramsNotes1"></textarea>
                    </td>
                    <td style="background-color: #FFFFFF;" class="border border-white">
            ...
            <tr class="th-blue-grey-lighten-2" id="rowofProgramExpenses">
                ...
                <td class="total-td" style="background-color: rgba(146, 146, 146, 0.727">
                    <h4 class="text-center text-danger " id="workshop_ProgramexpensesTotal">-</h4>
                </td>
                <td class="total-td">
                ...
                <td class="total-td">
                    <textarea type="text" class="form-control input-table @error('') is-invalid @enderror"
                        value="{{ old('') }}"name="cost_notes[]" id="ec_workshop_ProgramexpensesNotes1"></textarea>
                </td>
                <td style="background-color: #FFFFFF;" class="border border-white"></td>
            </tr>  

            <!--------------------------TOTAL-------------------------------------------->
            <tr class="" id="workshop_allTotals">
                ...
                <td class="table-active overall-total-middle" style="border:3px solid black">
                    <h4 class="text-center text-danger  text-danger" id="workshop_Totals">-</h4>
                </td>
...
@include('form.components.mgtstrat_u_workshop.workshop_script.workshop_engagement_cost')
<script>
...
@if($parentInfoList)
    ...
    $(document).ready( function () {
        ...
        @foreach($parentCostList as $cost)

            @if($cost->type == 'Sales') 

                if (salesCount <= 1) {
                    document.getElementById('workshop_sale').value = '{{ $cost->hour_fee }}';
                    ...
                    document.getElementById('ec_workshop_saleNotes1').value = '{{ $cost->notes }}';
                } else {                    
                    document.getElementById('workshop_sale').style.display = 'none';
                    ...
                    document.getElementById('ec_workshop_saleNotes' + salesCount).value = '{{ $cost->notes }}';
                }
                salesCount++;
            @endif
            ...
            @if($cost->type == 'Referral') 
                if (referralCount <= 1) {
                    document.getElementById('workshop_referrals').value = '{{ $cost->hour_fee }}';
                    ...
                    document.getElementById('ec_workshop_referralsNotes1').value = '{{ $cost->notes }}';
                } else {                    
                    document.getElementById('workshop_referrals').style.display = 'none';
                    ...
                    document.getElementById('ec_workshop_referralsNotes' + referralCount).value = '{{ $cost->notes }}';
                }
                referralCount++;
            @endif
            ...
            @if($cost->type == 'Engagement Manager') 
                if (engagementManagerCount <= 1) {
                    document.getElementById('workshop_engagementManager').value = '{{ $cost->hour_fee }}';
                    ...
                    document.getElementById('ec_workshop_engagementManagerNotes1').value = '{{ $cost->notes }}';
                } else {                    
                    document.getElementById('workshop_engagementManager').style.display = 'none';
                    ...
                    document.getElementById('ec_workshop_engagementManagerNotes' + engagementManagerCount).value = '{{ $cost->notes }}';
                }
            ...
            @if($cost->type == 'Customization Fee')
                ...
                document.getElementById('workshop_CustomizationHf' + customFeeCount).value = '{{ $cost->hour_fee }}';
                document.getElementById('workshop_CustomizationNoh' + customFeeCount).value = '{{ $cost->hour_num }}';
                ...
                document.getElementById('ec_workshop_CustomizationsNotes' + customFeeCount).value = '{{ $cost->notes }}';
                customFeeCount++;
            @endif
            ...
            @if($cost->type == 'Creators Fees') 
                ...
                document.getElementById('workshop_CreatorHf' + creatorsFeeCount).value = '{{ $cost->hour_fee }}';
                document.getElementById('workshop_CreatorNoh' + creatorsFeeCount).value = '{{ $cost->hour_num }}';
                ...
                document.getElementById('ec_workshop_CreatorNotes' + creatorsFeeCount).value = '{{ $cost->notes }}';
                creatorsFeeCount++;
            @endif
            ...
            @if($cost->type == 'Lead Facilitator')
                ...
                document.getElementById('workshop_LeadfacilitatorsHf' + leadFacilitatorCount).value = '{{ $cost->hour_fee }}';
                document.getElementById('workshop_LeadfacilitatorsNoh' + leadFacilitatorCount).value = '{{ $cost->hour_num }}';                
                document.getElementById('workshop_LeadfacilitatorsNwh' + leadFacilitatorCount).value = '{{ $cost->nswh }}';
                ...
                document.getElementById('ec_workshop_leadfacilitatorNotes' + leadFacilitatorCount).value = '{{ $cost->notes }}';
            ...
            @if($cost->type == 'Moderator')
                ...
                document.getElementById('workshop_ModeratorHf' + moderatorCount).value = '{{ $cost->hour_fee }}';
                document.getElementById('workshop_ModeratorNoh' + moderatorCount).value = '{{ $cost->hour_num }}';                
                document.getElementById('workshop_ModeratorNwh' + moderatorCount).value = '{{ $cost->nswh }}';
                ...
                document.getElementById('ec_workshop_ModeratorNotes' + moderatorCount).value = '{{ $cost->notes }}';
                moderatorCount++;
            @endif
            ...
            @if($cost->type == 'Producer') 
                ...
                document.getElementById('workshop_ProducerHf' + producerCount).value = '{{ $cost->hour_fee }}';
                document.getElementById('workshop_ProducerNoh' + producerCount).value = '{{ $cost->hour_num }}';                
                document.getElementById('workshop_ProducerNwh' + producerCount).value = '{{ $cost->nswh }}';
                ...
                document.getElementById('ec_workshop_ProducersNotes' + producerCount).value = '{{ $cost->notes }}';
                producerCount++;
            @endif
            ...
            @if($cost->type == 'Off-Program Fee') 
                ...
                document.getElementById('workshop_OffprogramsHf' + offProgramFeeCount).value = '{{ $cost->hour_fee }}';   
                document.getElementById('workshop_OffprogramsNoh' + offProgramFeeCount).value = '{{ $cost->hour_num }}';               
                ...
                document.getElementById('ec_workshop_OffprogramsNotes' + offProgramFeeCount).value = '{{ $cost->notes }}';
                offProgramFeeCount++;
            @endif

            @if($cost->type == 'Program Expenses') 
                document.getElementById('workshop_Programexpenses').value = '{{ $cost->hour_fee }}';               
                ...
                document.getElementById('ec_workshop_ProgramexpensesNotes1').value = '{{ $cost->notes }}';
            @endif
