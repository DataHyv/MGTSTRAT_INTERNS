@section('title', 'MGTSTRAT-U Workshops RECORD')
                    ...
                    <div class="col-12 col-md-6 order-md-2 order-first">
                        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                            <ol class="breadcrumb bg-transparent">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">MGTSTRAT-U Workshop Engagement</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <section class="section">
                <div class="card mb-5 mt-5">
                    <div class="card-header col-12 d-flex justify-content-left mt-3 mb-3">
                        <a class="btn btn-primary mt-2 mb-2" href="{{ route('form/mgtstratu_workshops/newrecord') }}">
                    ...
                    <div class="card-body table-responsive">
                        <table class="table display dt-responsive nowrap text-dark" id="table1">
                            ...
                            <tbody>
                                @foreach ($workshopList as $key => $item)
                                    <tr id="{{ ++$table }}">
                                        <td class="id text-center text-uppercase fw-bold" role="button" data-toggle="modal" data-target="#bigbudgetlist{{ $item->id }}"> {{ $item->workshop_eng_form_id }} </td>
                                        ...
                                        <td class="text-center fw-bold text-center">
                                            <a href="{{ url('update_workshop_eng/'.$item->id) }}">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered modal-md">
                                                    <div class="modal-content">
                                                        <div class="modal-header" style="justify-content: center;">
                                                            <h3 class="mb-2 text-center">MGTSTRAT-U Workshop</h3>
                                                        </div>
                                                        <div class="modal-body">
                                                            ...
                                                            <form action="{{ route('workshop_deleteRecord') }}" method="POST">
                                                                @csrf
                                                                <input type="hidden" name="id" class="e_id" value="">
                                                                <input type="hidden" name="workshop_engagement_forms_id" class="budget_number" value="{{ $item->id }}">
                                            ...
                                            <div class="modal fade" id="bigbudgetlist{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                            ...
                                                            <table class="table table-light display dt-responsive nowrap tables" id="tables{{ $table }}">
                                                                ...
                                                                <tbody class="text-center appendBatch" style="font-family:Arial, Helvetica, sans-serif">
                                                                    @foreach ($subInfoList as $key => $item2)
                                                                        @if($item->id == $item2->workshop_engagement_forms_id)
                                                                            <tr>
                                                                                <td>
                                                                                ...
                                                                                <td>
                                                                                    <a href="{{ url('form/workshopEngagement/sub-form/' . $item2->id) }}" class="text-success font-18 px-0" title="Add" id="edit">
                                                        ...
                                                        <div class="modal-footer">                                                           
                                                            <a href="{{ url('form/workshopEngagement/sub-form/modify-sessions/' . $item->id) }}" class="btn btn-success active" role="button">
