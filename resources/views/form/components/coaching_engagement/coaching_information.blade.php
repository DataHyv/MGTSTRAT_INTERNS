...
<div class="form-body container">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
            <div class="form-group has-icon-left">
                <div class="position-relative">
                    <!-- <input type="text" class="form-control @error('') is-invalid @enderror" value="{{ old('') }}" name="engagement_title" id="engagement_title" required> -->
...
@if($parentInfoList)
    <script>
        ...
        if (document.getElementById('engagement_title').value == '- MIXED -') {            
