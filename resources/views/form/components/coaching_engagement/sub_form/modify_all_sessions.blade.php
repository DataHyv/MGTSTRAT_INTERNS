...
<div class="customized-engagement" id="main">
    ...
    <div class="card">
        ...
        <div class="card-content">
            {{-- card body --}}
            <div class="card-body">
                <form class="form form-horizontal multisteps-form__form" action="{{ route('form/coachingEngagement/sub-form/savebatchsessions') }}" method="POST" autocomplete="off"> 
                @csrf 
                ...
                <div class="alert alert-light row" role="alert" style="border-left: 3px solid #818182;">    
                    <div class="col-lg-6 col-md-6"> 
                        ...
                        <a href="{{ url('update_coaching_eng/' . $parentData[0]->id ) }}" target="_blank">
                            <h5 id="engType" style="text-decoration: underline">
                                {{ ($parentData[0]->engagement_title == '- MIXED -') ? $parentData[0]->engagement_title_not_listed : $parentData[0]->engagement_title; }}
                            </h5>
                        </a>
                    </div>
                    <div class="col-lg-6 col-md-6"> 
                        <span style="font-size:10pt">Form ID</span>
                        <h5 id="paxhNo">{{ $parentData[0]->coaching_eng_form_id }}</h5>
                                ...
                                <!------------------- TABLE HEAD ----------------------->
                                    <thead class="th-blue-grey">
                                        <tr class="text-center">
                                            ...
                                            <th colspan="1">Consulting/Design</th>  
                                    ...
                                    <thead class="th-blue-grey-lighten">
                                        <tr class="text-center text-sm">
                                            ...
                                            <th class="p-1" style="min-width: 200px">Consulting and/or Design<h6><small>[Roster]</small></h6></th>                                              
                                            <th class="p-1" style="min-width: 200px">Executive Coaching <h6><small>[Roster]</small></h6></th>  
                                            <th class="p-1" style="min-width: 200px">Performance Development Coaching <h6><small>[Hourly Fees]</small></h6></th>
                                            <th class="p-1" style="min-width: 200px">Gallup Strengths Coaching <h6><small>[R oster]</small></h6></th>  
                                            <th class="p-1" style="min-width: 200px">WIAL Action Learning Team Coaching <h6><small>[Roster]</small></h6></th> 
                                        </tr>
                                    </thead>
                                <!------------------- END TABLE HEAD ----------------------->
                                ...
                                <tbody>
                                    <tr class="th-blue-grey-lighten-2">
                                        <td class="p-1">
                                            ...
                                            <a href="{{ url('form/coachingEngagement/sub-form/' . $subInfo_data->id) }}" target="_blank" class="text-primary text-link" title="View Record"> 
                                        ...
                                        <td class="p-1">
                                            @foreach($subCostData as $subCostData_record)
                                                @if($subCostData_record->coaching_sub_informations_id ==  $subInfo_data->id && $subCostData_record->type == 'Sales')
                                                    ...
                                                    <input  type="hidden" value="{{$subCostData_record->session_fee}}" name="cost_session_fee[{{ $recordCount }}][]" 
                                        ...
                                        <td class="p-1">
                                            @foreach($subCostData as $subCostData_record)
                                                @if($subCostData_record->coaching_sub_informations_id ==  $subInfo_data->id && $subCostData_record->type == 'Referral')
                                                    <input type="hidden" value="{{$subCostData_record->id}}" name="subcost_id[{{ $recordCount }}][]">
                                                    <input type="text" class="d-none" value="{{$subCostData_record->type}}" name="cost_type[{{ $recordCount }}][]" readonly>
                                                    <input type="text" class="form-control input-table" name="cost_rooster[{{ $recordCount }}][]" 
                                                    id="roster_batch{{ $subInfo_data->batch_number }}session{{ $subInfo_data->session_number }}_subinfo{{$subInfo_data->id}}_subcos{{$subCostData_record->id}}"
                                        ...
                                        <td class="p-1">
                                            @foreach($subCostData as $subCostData_record)
                                                @if($subCostData_record->coaching_sub_informations_id ==  $subInfo_data->id && $subCostData_record->type == 'Engagement Manager')
                                                    <input type="hidden" value="{{$subCostData_record->id}}" name="subcost_id[{{ $recordCount }}][]">
                                                    <input type="text" class="d-none" value="{{$subCostData_record->type}}" name="cost_type[{{ $recordCount }}][]" readonly>
                                                    <input type="text" class="form-control input-table" name="cost_rooster[{{ $recordCount }}][]" 
                                                    id="roster_batch{{ $subInfo_data->batch_number }}session{{ $subInfo_data->session_number }}_subinfo{{$subInfo_data->id}}_subcos{{$subCostData_record->id}}"
                                        ...
                                        <td class="p-1">
                                            @foreach($subCostData as $subCostData_record)
                                                @if($subCostData_record->coaching_sub_informations_id ==  $subInfo_data->id && $subCostData_record->type == 'Consulting Design')
                                                    <input type="hidden" value="{{$subCostData_record->id}}" name="subcost_id[{{ $recordCount }}][]">
                                                    <input type="text" class="d-none" value="{{$subCostData_record->type}}" name="cost_type[{{ $recordCount }}][]" readonly>
                                                    <input type="text" class="form-control input-table" name="cost_rooster[{{ $recordCount }}][]" 
                                                    id="roster_batch{{ $subInfo_data->batch_number }}session{{ $subInfo_data->session_number }}_subinfo{{$subInfo_data->id}}_subcos{{$subCostData_record->id}}"
                                        ...
                                        <td class="p-1">
                                            @foreach($subCostData as $subCostData_record)
                                                @if($subCostData_record->coaching_sub_informations_id ==  $subInfo_data->id && $subCostData_record->type == 'Executive Coaching')
                                                    <input type="hidden" value="{{$subCostData_record->id}}" name="subcost_id[{{ $recordCount }}][]">
                                                    <input type="text" class="d-none" value="{{$subCostData_record->type}}" name="cost_type[{{ $recordCount }}][]" readonly>
                                                    <input type="text" class="form-control input-table" name="cost_rooster[{{ $recordCount }}][]" 
                                                    id="roster_batch{{ $subInfo_data->batch_number }}session{{ $subInfo_data->session_number }}_subinfo{{$subInfo_data->id}}_subcos{{$subCostData_record->id}}"
                                        ...
                                        <td class="p-1">
                                            @foreach($subCostData as $subCostData_record)
                                                @if($subCostData_record->coaching_sub_informations_id ==  $subInfo_data->id && $subCostData_record->type == 'Performance Development Coaching')
                                                    <input type="hidden" value="{{$subCostData_record->id}}" name="subcost_id[{{ $recordCount }}][]">
                                                    <input type="text" class="d-none" value="{{$subCostData_record->type}}" name="cost_type[{{ $recordCount }}][]" readonly>
                                                    <input type="text" class="form-control input-table" name="cost_rooster[{{ $recordCount }}][]" 
                                                    id="roster_batch{{ $subInfo_data->batch_number }}session{{ $subInfo_data->session_number }}_subinfo{{$subInfo_data->id}}_subcos{{$subCostData_record->id}}"
                                        ...
                                        <td class="p-1">
                                            @foreach($subCostData as $subCostData_record)
                                                @if($subCostData_record->coaching_sub_informations_id ==  $subInfo_data->id && $subCostData_record->type == 'Gallup Strengths Coaching')
                                                    <input type="hidden" value="{{$subCostData_record->id}}" name="subcost_id[{{ $recordCount }}][]">
                                                    <input type="text" class="d-none" value="{{$subCostData_record->type}}" name="cost_type[{{ $recordCount }}][]" readonly>
                                                    <input type="text" class="form-control input-table" name="cost_rooster[{{ $recordCount }}][]" 
                                                    id="roster_batch{{ $subInfo_data->batch_number }}session{{ $subInfo_data->session_number }}_subinfo{{$subInfo_data->id}}_subcos{{$subCostData_record->id}}"
                                        ...
                                        <td class="p-1">
                                            @foreach($subCostData as $subCostData_record)
                                                @if($subCostData_record->coaching_sub_informations_id ==  $subInfo_data->id && $subCostData_record->type == 'WIAL Action Learning Team Coaching')
                                                    <input type="hidden" value="{{$subCostData_record->id}}" name="subcost_id[{{ $recordCount }}][]">
                                                    <input type="text" class="d-none" value="{{$subCostData_record->type}}" name="cost_type[{{ $recordCount }}][]" readonly>
                                                    <input type="text" class="form-control input-table" name="cost_rooster[{{ $recordCount }}][]" 
                                                    id="roster_batch{{ $subInfo_data->batch_number }}session{{ $subInfo_data->session_number }}_subinfo{{$subInfo_data->id}}_subcos{{$subCostData_record->id}}"
